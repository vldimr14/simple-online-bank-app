...
class Transaction extends DbHandler
{
    ...
    //     public static function findTransaction($client, $searchQuery)
    //     {

    //         $transactionHistory = [];

    //         $columns = ["transactions_id", "transactions_date", "transactions_description", "transactions_amount", "accounts.accounts_currency", "transactions_senderAccountId", "transactions_recipientAccountId", "transactions_senderId"];

    //         foreach ($columns as $column) {
    //             $sql = "SELECT transactions_id, transactions_date, transactions_description, transactions_amount, accounts.accounts_currency, transactions_senderAccountId, transactions_recipientAccountId, transactions_senderId FROM transactions 
    //                     INNER JOIN accounts ON transactions.transactions_senderId = accounts.clients_id 
    //                     WHERE $column = :searchQuery
    //                     ORDER BY transactions_date DESC;";
    ...
    //             if ($stmt = $pdo->prepare($sql)) {
    //                 // Bind variables to the prepared statement as parameters
    //                 $stmt->bindParam(":searchQuery", $param_searchQuery, PDO::PARAM_STR);

    //                 // Set parameters
    //                 $param_searchQuery = $searchQuery;
    ...
    //                 }
    //             } else {
    //                 exit("Prepared statement failed. (findTransaction)");
    //             }
    //         }
